...
Dose.create(description: "hello", cocktail_id: 16 , ingredient_id: 1)
Dose.create(description: "Put some ice", cocktail_id: 16 , ingredient_id: 2)
Dose.create(description: "hello 2", cocktail_id: 15 , ingredient_id: 2)
